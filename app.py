...
def visualize_concepts():
    ...
    concept_mean = create_horizontal_bar_plot(concepts, cosine_similarities_mean, 'Concept impact on the output', 'Mean cosine similarity over a few shot')
    concept_variance = create_horizontal_bar_plot(concepts, cosine_similarities_variance, 'Estimated variability of the given output', 'Cosine similarity variance over a few shot')
